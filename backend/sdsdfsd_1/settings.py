"""
Django settings for sdsdfsd_1 project.
...
WSGI_APPLICATION = 'sdsdfsd_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sdsdfsd_1 API",
    "DESCRIPTION": "API documentation for sdsdfsd_1 App",
    "VERSION": "v1",
}
